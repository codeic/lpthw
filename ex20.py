...
# This line defines function with one parameter, same as in the previous
# function. 
def rewind(f):
# This line seeks for reference point ('f') which is the beginning of 
# the file, since '0' is given as 'from_what' parameter.
...
# This line prints first parameter, then prints out readings of one 
# line of the second parameter.
...
# This line assigns value to variable and increments it further.
current_line += 1
# This line calls function and gives it two variables as parameters.
print_a_line(current_line, current_file)
...
# function call, and trace how it becomes line_count in print_a_line.
    # A:
    # First current_line is equal to 1. Later on, it is incremented
    # every time for 1. It is same as line_count because it is 
    # called as a part of a function (print_a_line) and it serves it
...
# file and see if you can figure it out from there.
    # A:
    # The answer is already written where the line with seek function
    # is explained.
